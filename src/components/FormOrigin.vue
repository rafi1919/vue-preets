<template>
       <div id="homeform" >
        ...
        <div class="output grid place-items-center h-screen">
            ...
            <form onsubmit="return false" class="w-full p-5" runat="server">
                    <div class="">
                        <input type="file" @change="onFileChange" @input="changeFormData({ ['url']: $event.target.value })" />
                        <div id="preview">
                            <img v-if="url" :src="url" id="blah"/>
                        </div>
                        <form>
